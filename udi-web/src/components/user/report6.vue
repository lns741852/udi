  ...
  <div class="board-center">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="reportList" style="width: 100%">
        ...
        <el-table-column prop="mknum" label="製作數量" align="center" />
        <el-table-column prop="rnum" label="歸還數量" align="center" />
      </el-table>
    </el-card>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getReportList() {
      ...
      this.$axios.get("/report/06", this.queryInfo).then((res) => {
    ...
    exportReport() {
      ...
      this.$downloadRequest("/report/06/export", this.queryInfo);
    },
  },
};
</script>
